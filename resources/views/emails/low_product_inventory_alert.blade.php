...
<head>
    ...
    <title>Low Product Inventory Alert</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="email-container">
    ...
    <div class="header">
        ...
        <h1>Low Product Inventory Alert</h1>
    ...
    <div class="content">
        ...
        <div class="message">
            This is an automated alert to notify you that several products in your inventory have reached or fallen below their minimum stock levels and require urgent replenishment.
        </div>

        <!-- Summary -->
        <div class="alert-summary">
            <h3>📊 Alert Summary</h3>
            <p><strong>Total Items:</strong> {{ count($products) }} product(s) require immediate attention</p>
        ...
        <!-- Products Table -->
        <h3 style="margin: 22px 0 12px 0; color: #333333;">Products Requiring Attention:</h3>
            ...
            <table class="materials-table">
                ...
                @foreach($products as $product)
                    @php
                        ...
                        $minimumQty = $product->minimum_qty ?? 0;
        ...
        <div class="message">
            <strong>Recommended Action:</strong> Please review the inventory levels and initiate purchase orders for the affected products to prevent stock shortages.
        </div>
    </div>
